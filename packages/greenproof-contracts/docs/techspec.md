...
- **safeBatchTransferFrom(
  ...
  - **TimeToRevokeHasElapsed(uint256 certificateID, uint256 issuanceDate, uint256 timeToRevoke)**: reason of rejection, when revoker tries to revoke certificate which revocation period has expired.
